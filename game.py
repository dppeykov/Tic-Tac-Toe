# REPL - https://repl.it/@DamyanPeykov/Tic-Tac-Toe-project
...
def players_symbols():
  ...
  while not(marker == "X" or marker == "O"):
    ...
    if marker == "X":
      p1 = marker
      p2 = "O"
      print("\nGreat! Player 1 will be {} and Player 2 will be {}!". format(p1,p2))
...
def win_check(board, mark):
  ...
  if board[1:4] == [mark, mark, mark] or \
    board[4:7] == [mark, mark, mark] or \
    board[7:10] == [mark, mark, mark] or \
